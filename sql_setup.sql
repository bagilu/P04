...
CREATE INDEX IF NOT EXISTS idx_p04_my_smile_records ON public.tblp04smileevents(smiler_account, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_p04_my_response_records ON public.tblp04smileevents(responder_account, created_at DESC);
